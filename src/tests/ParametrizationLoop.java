...
public class ParametrizationLoop extends HotelApp_BusinessFunctions{
 ...
 // public Properties Prop;
  ...
  public void testMyfirstwebdriver() throws Exception {
	  driver.get(baseUrl);
	  String strfilepath = "./DataPool/HA_SearchResults.xls";
	  int iRowCount = HA_GF_XLRowCount (strfilepath, "Location");
	  for (int i=1; i<iRowCount; i++)
	  {
	  String strlocation = HA_GF_readXL(i, "Location", strfilepath);
